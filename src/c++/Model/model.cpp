...
void Model::processGraph(Wire* first,int number)
{
    //удаление предыдущих бранчей
    //delete diodesBranches;

    diodesBranches->clear();
